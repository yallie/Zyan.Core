...
public static partial class Extensions
{
    ...
    public static object Invoke(this MethodInfo mi, object instance, object[] args, bool oneWay)
    {
        if (oneWay)
        {
            // the current session is preserved as a part of the LogicalCallContext
    ...
    /// <summary>
    /// Registers queryable methods of the given service.
    /// </summary>
    ...
    /// <param name="uniqueName">Service unique name</param>
    /// <returns></returns>
    internal static IDependencyInjectionContainer RegisterQueryableMethods<TInterface, TService>(
        this IDependencyInjectionContainer container,
        ServiceLifetime lifetime = ServiceLifetime.SingleCall,
        string uniqueName = "")
